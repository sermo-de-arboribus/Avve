...
public class XmlService
{
	...
	private static String textExtractionFromHtml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>" + 
			...
			"	<xsl:template match=\"*[local-name() = 'td' or @class = 'left2']\">"+
			"		<xsl:text> </xsl:text><xsl:apply-templates/><xsl:text> </xsl:text>" + 
			"	</xsl:template>"+
			
//			"   <xsl:template match=\"*[local-name() = 'span' and (@reg-begriff1 or @reg-begriff2 or @reg-begriff3 or @reg-begriff4)]\" /> "+
			"   <xsl:template match=\"*[local-name() = 'span' and (@class = 'reg-begriff1' or @class = 'reg-begriff2' or @class = 'reg-begriff3' or @class = 'reg-begriff4')]\" /> "+
